<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <div class="">
        <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
                <a href="" class="menu-link menu-toggle">
                    <i class="menu-icon tf-user bx bx-layout"></i>
                    <div class="text-truncate" data-i18n="Layouts">Pengguna</div>
                </a>
            </li>
        </ul>
        ...
        <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
                <a href="" class="menu-link menu-toggle">
                    <i class="menu-icon tf-icons bx bx-layout"></i>
                    <div class="text-truncate" data-i18n="Layouts">Help Center</div>
                </a>
            </li>
        </ul>
    </div>
